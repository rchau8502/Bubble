...
export const multivariableCalculusTwoCourse: CourseContent = {
  ...
  units: [
    "Sections 13.1-13.3: Vector Functions Review",
    "Sections 16.1-16.4: Vector Fields and Line Integrals",
    "Sections 16.5-16.7: Curl, Divergence, and Surface Integrals",
    "Sections 16.8-16.9: Big Vector-Calculus Theorems",
  ],
  chapters: [
    "Sections 13.1-13.3: Vector Functions Review",
    "Sections 16.1-16.4: Vector Fields and Line Integrals",
    "Sections 16.5-16.7: Curl, Divergence, and Surface Integrals",
    "Sections 16.8-16.9: Stokes and Divergence Theorems",
  ],
  cards: [
    makeMath2ECard({
      id: "math2e-vector-functions",
      chapter: "Section 13.1: Vector Functions and Space Curves",
      unit: "Sections 13.1-13.3: Vector Functions Review",
    ...
    makeMath2ECard({
      ...
      chapter: "Section 13.3: Arc Length and Curvature Review",
      unit: "Sections 13.1-13.3: Vector Functions Review",
    ...
    makeMath2ECard({
      id: "math2e-motion-in-space",
      chapter: "Section 13.2: Derivatives and Integrals of Vector Functions",
      unit: "Sections 13.1-13.3: Vector Functions Review",
      topic: "Motion in space",
      name: "Motion in Space",
      order: 2.5,
      useItWhen: "a vector-valued function is describing position over time",
      looksLike: "r(t), v(t), a(t), speed",
      doThis: "differentiate position to get velocity, then differentiate again for acceleration",
      thinkOfItAs: "position feeds velocity, and velocity feeds acceleration",
      watchOutFor: "mixing up the vector velocity with the scalar speed",
      rememberThis: "velocity is a vector, speed is its length",
      quickExample: {
        problem: "If r(t) is position, what are r'(t) and r''(t)?",
        move: "Velocity first, acceleration second.",
      },
      typicalProblemShapes: [
        "A moving particle described by r(t)",
        "Questions about speed, acceleration, or when the particle stops",
      ],
      miniDrill: [
        {
          prompt: "What is r'(t) in a motion problem?",
          answer: "Velocity.",
        },
        {
          prompt: "What is speed in terms of velocity?",
          answer: "The magnitude |v(t)|.",
        },
      ],
      memoryHook: "Differentiate position once for velocity, twice for acceleration.",
      tags: ["math2e", "motion", "velocity", "acceleration"],
      difficulty: "Starter",
    }),
    makeMath2ECard({
      id: "math2e-line-integrals",
      chapter: "Section 16.2: Line Integrals",
      unit: "Sections 16.1-16.4: Vector Fields and Line Integrals",
    ...
    makeMath2ECard({
      ...
      chapter: "Section 16.3: The Fundamental Theorem for Line Integrals",
      unit: "Sections 16.1-16.4: Vector Fields and Line Integrals",
    ...
    makeMath2ECard({
      id: "math2e-ftc-line-integrals",
      chapter: "Section 16.3: The Fundamental Theorem for Line Integrals",
      unit: "Sections 16.1-16.4: Vector Fields and Line Integrals",
      topic: "Fundamental theorem for line integrals",
      name: "FTC for Line Integrals",
      order: 4.5,
      useItWhen: "a line integral is over a gradient field and you know a potential function",
      looksLike: "gradient field, path independence, phi(B)-phi(A)",
      doThis: "identify the potential and subtract endpoint values",
      thinkOfItAs: "single-variable FTC, but along a path",
      watchOutFor: "doing the whole line integral after already proving the field is conservative",
      rememberThis: "gradient field means endpoint subtraction",
      quickExample: {
        problem: "What shortcut replaces the full line integral when F = grad phi?",
        move: "Use phi(end) minus phi(start).",
      },
      typicalProblemShapes: [
        "Line integral over a gradient field",
        "A conservative-field problem asking for the exact theorem name",
      ],
      miniDrill: [
        {
          prompt: "What two points matter once you know the field is conservative?",
      ...
      tags: ["math2e", "line-integral", "ftc", "potential"],
      difficulty: "Standard",
    }),
    makeMath2ECard({
      id: "math2e-greens-theorem",
      chapter: "Section 16.4: Green's Theorem",
      unit: "Sections 16.1-16.4: Vector Fields and Line Integrals",
    ...
    makeMath2ECard({
      ...
      chapter: "Section 16.7: Surface Integrals",
      unit: "Sections 16.5-16.7: Curl, Divergence, and Surface Integrals",
    ...
    makeMath2ECard({
      id: "math2e-parametric-surfaces",
      chapter: "Section 16.6: Parametric Surfaces and Their Areas",
      unit: "Sections 16.5-16.7: Curl, Divergence, and Surface Integrals",
      topic: "Parametric surfaces and their areas",
      name: "Parametric Surfaces",
      order: 6.5,
      useItWhen: "a surface is built from two parameters instead of one graph equation",
      looksLike: "r(u,v), tangent vectors, surface patch",
      doThis: "differentiate with respect to u and v, then cross them for the area element",
      thinkOfItAs: "a curved sheet woven from two parameter directions",
      watchOutFor: "forgetting the cross product when building the surface-area factor",
      rememberThis: "two parameters mean two tangent vectors",
      quickExample: {
        problem: "What creates the surface-area element on a parametric surface?",
        move: "Cross the two tangent vectors.",
      },
      typicalProblemShapes: [
        "A surface given by r(u,v)",
        "Area or flux setup on a parameterized surface",
      ],
      miniDrill: [
        {
          prompt: "What are the two basic tangent vectors on r(u,v)?",
          answer: "r_u and r_v.",
        },
        {
          prompt: "What gives the area factor?",
          answer: "|r_u x r_v|.",
        },
      ],
      memoryHook: "Two surface directions, then cross.",
      tags: ["math2e", "parametric-surface", "surface-area"],
      difficulty: "Standard",
    }),
    makeMath2ECard({
      id: "math2e-divergence-curl",
      chapter: "Section 16.5: Curl and Divergence",
      unit: "Sections 16.5-16.7: Curl, Divergence, and Surface Integrals",
    ...
    makeMath2ECard({
      ...
      chapter: "Sections 16.8-16.9: Stokes and Divergence Theorems",
      unit: "Sections 16.8-16.9: Big Vector-Calculus Theorems",
