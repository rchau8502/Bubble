...
export const linearAlgebraOneCourse: CourseContent = {
  ...
  cards: [
    ...
    makeLAOneCard({
      id: "la121a-rank-nullity",
      chapter: "Chapter 3: Linear Maps",
      unit: "Linear Maps",
      topic: "Rank-nullity theorem",
      name: "Rank-Nullity",
      order: 8,
      useItWhen: "kernel size and image size are linked in a finite-dimensional space",
      looksLike: "dim V = nullity(T) + rank(T)",
      doThis: "find two of the three dimension counts and use the equation",
      thinkOfItAs: "input dimensions split into lost directions and surviving directions",
      watchOutFor: "mixing the dimension of the codomain into the formula",
      rememberThis: "domain dimension = nullity + rank",
      quickExample: {
        problem: "If T: R^5 -> R^3 has nullity 2, what is rank(T)?",
        move: "Use rank-nullity: 5 = 2 + rank.",
      },
      typicalProblemShapes: [
        "A linear map with one of rank or nullity missing",
        "A proof relating injective, surjective, and dimension counts",
      ],
      miniDrill: [
        {
          prompt: "Which space's dimension appears on the left side of rank-nullity?",
          answer: "The domain.",
        },
        {
          prompt: "What two pieces split that dimension?",
          answer: "Nullity and rank.",
        },
      ],
      memoryHook: "Input dimensions split in two.",
      tags: ["linear-algebra", "rank-nullity", "math121a"],
      difficulty: "Standard",
    }),
    makeLAOneCard({
      id: "la121a-matrix-of-map",
      chapter: "Chapter 3: Linear Maps",
      unit: "Linear Maps",
      topic: "Matrix of a linear map",
      name: "Matrix of T",
      order: 9,
      useItWhen: "you need the matrix that represents a linear map in chosen bases",
      looksLike: "[T]_B or columns from T(b1), T(b2), ...",
      doThis: "apply T to each basis vector and use those coordinate outputs as the columns",
      thinkOfItAs: "the matrix is the map written in basis language",
      watchOutFor: "plugging arbitrary vectors first instead of starting with the basis vectors",
      rememberThis: "columns come from T on basis vectors",
      quickExample: {
        problem: "How do you build the matrix of T in a basis B?",
        move: "Send each basis vector through T and record the coordinates as columns.",
      },
      typicalProblemShapes: [
        "Find the matrix of a linear transformation in standard or custom bases",
        "Translate an abstract map into a matrix computation",
      ],
      miniDrill: [
        {
          prompt: "What vectors generate the columns of [T]?",
          answer: "The images of the basis vectors.",
        },
        {
          prompt: "What form should those images be written in?",
          answer: "Coordinates relative to the output basis.",
        },
      ],
      memoryHook: "Basis in, columns out.",
      tags: ["linear-algebra", "matrix-of-map", "linear-transformations"],
      difficulty: "Standard",
    }),
    makeLAOneCard({
      id: "la121a-isomorphism",
      chapter: "Chapter 3: Linear Maps",
      unit: "Linear Maps",
      topic: "Isomorphisms",
      name: "Isomorphism Check",
      order: 10,
      useItWhen: "two vector spaces are supposed to be structurally the same",
      looksLike: "isomorphic, one-to-one and onto linear map",
      doThis: "find a linear map and prove it is both injective and surjective",
      thinkOfItAs: "different-looking spaces with the same vector skeleton",
      watchOutFor: "showing the spaces have the same dimension without actually giving the map when a construction is asked",
      rememberThis: "isomorphism means linear, one-to-one, and onto",
      quickExample: {
        problem: "What do you prove to show V and W are isomorphic?",
        move: "Build a linear bijection.",
      },
      typicalProblemShapes: [
        "A polynomial or matrix space claimed to match R^n",
        "A proof asking whether two finite-dimensional spaces are 'the same'",
      ],
      miniDrill: [
        {
          prompt: "What three words define isomorphism here?",
          answer: "Linear, injective, surjective.",
        },
        {
          prompt: "What dimension clue often suggests an isomorphism might exist?",
          answer: "Same finite dimension.",
        },
      ],
      memoryHook: "Same structure means a linear bijection.",
      tags: ["linear-algebra", "isomorphism", "math121a"],
      difficulty: "Standard",
    }),
    makeLAOneCard({
      id: "la121a-change-of-basis",
      chapter: "Chapter 3: Linear Maps",
      unit: "Linear Maps",
      topic: "Change of basis",
      name: "Change of Basis",
      order: 11,
      useItWhen: "coordinates need to move from one basis language to another",
      looksLike: "[v]_B, [v]_C, change-of-basis matrix",
      doThis: "write the old basis vectors in the new basis and build the change matrix from those coordinates",
      thinkOfItAs: "same vector, new coordinate accent",
      ...
      typicalProblemShapes: [
        "Coordinate conversion between two nonstandard bases",
        "Similarity-style matrix questions that swap bases",
      ],
      miniDrill: [
        {
          prompt: "Does the vector change during a basis change?",
          answer: "No. Only its coordinates change.",
        },
        {
          prompt: "What gets written as columns in the change matrix?",
          answer: "The old basis vectors written in the new basis.",
        },
      ],
      memoryHook: "Same vector, new coordinates.",
      tags: ["linear-algebra", "change-of-basis", "coordinates"],
      difficulty: "Standard",
    }),
  ],
};
